...
html_temp = """<div style="background-color:#DAEC02;padding:10px;border-radius:10px">
			<h1 style="color:red;text-align:center;"> Innomatics Research Lab </h1>"""

about_me = """<h1 align="center"> Hello, I'm Shanu Halli </h1>
...
my_file = path +'/resources/images/Shanu.png'
img = Image.open(my_file)
st.image(img)

st.markdown ("<h3 style='color:#DE1F1F'>🙋‍♂️ About Myself </h3>",unsafe_allow_html=True)
st.write("""
...
st.markdown ("<h3 style='color:#DE1F1F'>👨‍💻 Machine Learning Projects </h3>",unsafe_allow_html=True)
st.write("""
